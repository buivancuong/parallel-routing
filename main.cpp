...
#include "experiment/serial/CORRAv1SExp.h"
#include "experiment/parallel/CORRAv1PExp.h"
...
int main() {
    ...
    auto *corrAv1PExp = new CORRAv1PExp(xBlockSize, yBlockSize, xTopoSize, yTopoSize, deltaNeighbor, alphas, 4);
    delete corrAv1PExp;
    return  0;
